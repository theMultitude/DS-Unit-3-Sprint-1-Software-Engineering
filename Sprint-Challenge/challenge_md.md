...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  - One of the main things I look for when reviewing code is readability.  Beyond efficiency and function I want to know what's going on almost immediately when I open a new codebase and try to parse the code.  This requires good commenting but also spacing and structure.

- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?

  - Containers are useful for solving this problem because they allow us to setup separate environments on a standardized base.  For example, using Docker as the standard structure, I can create a container with varied language setting, imports, and even a unique operating system.  Someone else can then import that container and have the exact same environment I had previously been using. Containers allow for reproducibility and consistency across different systems.
